...
if __name__ == "__main__":
    ...
    if args.mode == 'generate_cohort':
        ...
        for model in ["anthropic/sonnet-4.5"]: # "Qwen/Qwen3-1.7B", "Qwen/Qwen3-4B", "Qwen/Qwen3-8B", "Qwen/Qwen3-14B",  "openai/gpt-oss-120b", "google/medgemma-27b-text-it"
            ...
            for missingness in [True]:
                ...
                for icl_samples in [0, 20, 50]:
                    ...
                    for include_cot_prompt in [True]:
                        ...
                        # seeds = [1, 2, 3] if icl_samples != 0 else [1]
                        seeds = [1]
